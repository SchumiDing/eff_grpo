            ...
            if infer_mask.any():
                ...
                with torch.autocast("cuda", torch.bfloat16):
                    v_infer = transformer(
                        ...
                        img_shapes=[img_shapes[0]] * infer_mask.sum().item() if isinstance(img_shapes[0], tuple) else img_shapes,
...
def sample_reference_model(
    ...
    for index, batch_idx in enumerate(batch_indices):
        ...
        with torch.no_grad():
            z, latents, batch_latents, batch_log_probs, batch_mock_flags = run_sample_step(
                args,
        ...
        all_mock_flags.append(batch_mock_flags)
