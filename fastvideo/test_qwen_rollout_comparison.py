...
def test_comparison():
    ...
    parser.add_argument("--methods", type=str, nargs='+', default=["original", "mean_direction", "noise", "momentum", "reuse", "auto"], 
    ...
    # 检查哪些方法已经生成过，跳过已有的方法
    available_methods = ["original", "mean_direction", "noise", "momentum", "reuse", "auto"]
    methods_to_run = []
    ...
    method_names = {
        "original": "Original (No Guess - Baseline)",
