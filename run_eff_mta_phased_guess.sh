...
export RANK=0
export WORLD_SIZE=8
mkdir -p /dry-data/grpo_eff_mta_phased_guess

torchrun --nproc_per_node=8 --master_port 19003 \
    fastvideo/train_grpo_qwenimage_eff_mta_phased_guess.py \
    --seed 42 \
    ...
    --allow_tf32 \
    --cfg 0.0 \
    --output_dir /dry-data/grpo_eff_mta_phased_guess \
    --h 720 \
    --w 720 \
    --t 1 \
    --sampling_steps 20 \
