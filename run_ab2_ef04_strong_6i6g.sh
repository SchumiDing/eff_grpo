#!/bin/bash
# AB2 combo 训练：early_frac=0.4 + v_so=2*v_prev-1*v_pp，改为 6 infer + 6 guess。
...
OUT_DIR=/dry-data/grpo_eff_mta_ab2_ef04_strong_6i6g
mkdir -p "$OUT_DIR"

torchrun --nproc_per_node=8 --master_port 19014 \
